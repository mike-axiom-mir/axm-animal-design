...
const EXPECTED_SCHEMA := "axm.animal-materials-explicit-logical-quad-normal-review/v0.1"
...
func _ready() -> void:
    ...
    var telemetry := {
        "schema": "axm.animal-materials-explicit-logical-quad-normal-review-telemetry/v0.1",
        ...
        "truth_boundary": {
            ...
            "explicit_normal_candidate_is_tested": true,
            "tangents_or_uvs_are_tested": false,
            "deformed_normal_quality_is_tested": false,
    ...
    file.close()
    print("PASS_TARGET_HOST_EXPLICIT_LOGICAL_QUAD_NORMAL_REVIEW_CAPTURED")
    get_tree().quit(0)
...
func _set_mesh(variant: Dictionary, normal_mode: String) -> void:
    ...
    if normal_mode == "vertex_generated":
        ...
        var raw_normals: Array = variant["explicit_normals"]
